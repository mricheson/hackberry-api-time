...
public class User {
	...
	public Optional<LocalDate> getHireDateAsLocalDate() {
		if (StringUtils.isEmpty(getHire_date()) || getHire_date().equals(EMPTY_DATE))
			return Optional.empty();
		else
			return Optional.of(LocalDate.parse(getHire_date()));
	}
	...
	public Optional<LocalDate> getTermDateAsLocalDate() {
		if (StringUtils.isEmpty(getTerm_date()) || getTerm_date().equals(EMPTY_DATE))
			return Optional.empty();
		else
			return Optional.of(LocalDate.parse(getTerm_date()));
	}
